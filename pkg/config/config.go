...
func New() Config {
	return Config{
		...
		MDCImageStreamTag:         getEnv("MDC_IMAGE_STREAM_TAG", "1.1.10"),
		...
		MDCImageStreamInitialImage:        getEnv("MDC_IMAGE_STREAM_INITIAL_IMAGE", "quay.io/aerogear/mobile-developer-console:1.1.10"),
