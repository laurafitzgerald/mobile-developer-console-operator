...
in its web UI to make calls to OpenShift REST API. Thus the the value given in the environment variable must be public and accessible by potential users'
