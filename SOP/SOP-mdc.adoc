...
mdc       3          1         1         config,image(mdc-imagestream:1.1.10),image(mdc-oauth-proxy-imagestream:latest)
----
...
mdc   1          2         2         config,image(mdc-imagestream:1.1.10),image(mdc-oauth-proxy-imagestream:latest)
----
+
